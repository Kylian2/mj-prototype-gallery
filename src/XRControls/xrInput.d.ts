...
export declare class XrInput {
    ...
    updateJump(): void;
    rotatePlayer(): void;
    setAlwaysOnFlyingMode(status: boolean): void;
    setFlyingMethod(method: 0 | 1): void;
    setFlyingMode(status: boolean): void;
    setJump(status: boolean): void;
    setDiscreteRotation(status: boolean): void;
    setOnColliderEnter(callback: function): void;
    setOnColliderStay(callback: function): void;
    setOnColliderExit(callback: function): void;
    setOnPointing(callback: function): void;
    getLeftController(): XrMechanicalControllerInput;
    getRightController(): XrMechanicalControllerInput;
    addColliderTarget(target = undefined, collider = 'both'): void
}   